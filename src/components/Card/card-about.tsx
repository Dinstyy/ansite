...
const CardAbout: FC<CardAboutProps> = (props) => {
  ...
  return (
    <div
      className="flex items-center gap-2 rounded border border-purple-500 px-2 py-2 hover:bg-purple-400 hover:bg-opacity-10 md:gap-3 lg:px-3"
    ...
    >
      ...
      <div className="flex items-center text-sm md:text-base lg:text-lg">
        ...
        <div
          ...
          } absolute mt-6 font-mono text-[10px] text-purple-500 transition-all duration-300 md:text-xs lg:text-sm`}
        >
          {informationLevel}
        </div>
      </div>
