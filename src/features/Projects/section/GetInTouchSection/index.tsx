...
const GetInTouchSection: FC = () => {
  return (
    <section className="my-60 flex flex-col items-center justify-center gap-3 text-center md:gap-5">
      <p className="font-mono text-purple-500" data-aos="fade-up">
        What{`'`}s Next?
      </p>
      <h1
      ...
      <button
        className="rounded-[4px] border-2 border-purple-500 px-7 py-4 font-mono text-purple-500 transition-all duration-300 hover:bg-purple-400 hover:bg-opacity-10"
        data-aos="flip-up"
        data-aos-duration="600"
      >
        <a href="mailto:andiniazzahrapuspita0727@gmail.com">Say Hello</a>
      </button>
    </section>
  );
};
