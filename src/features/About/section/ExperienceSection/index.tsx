        ...
        >
          <div className="flex w-[370px] flex-row overflow-x-scroll font-mono text-sm text-primary md:w-auto md:flex-col  md:overflow-auto">
            {categories.map((category) => (
              <button
                className={`w-auto whitespace-nowrap px-4 py-3 text-start text-xs transition-all duration-300 hover:bg-accent/10 hover:text-purple-500 md:py-3 md:px-5 md:text-base ${
                  activeCategory === category.value
                    ? "bg-accent/10 text-purple-500"
                    : ""
                }`}
